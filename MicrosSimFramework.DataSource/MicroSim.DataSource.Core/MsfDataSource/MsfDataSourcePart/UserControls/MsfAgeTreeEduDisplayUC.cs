...
namespace MicroSim.DataSource.Core
{
    ...
    public partial class MsfAgeTreeEduDisplayUC : 
        MsfAgeTreeDisplayGenericUC<Education, IPopulationEduEntity, IPopulationEntity>
    {
        /// <summary>
        ...
        protected override IEnumerable<IPopulationEntity> GetSubData(Enum e)
            => Data.Where(d => d.Education == (Education)e);
    }
}
