...
{
    /// <summary>
    /// DspFertilityForecastAgeTree class
    /// </summary>
    ...
    public class DspFertilityForecastAgeTree : MsfDataSourcePart<FertilityCompleteBaseEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DspFertilityForecastAgeTree"/> class.
        /// </summary>
        /// <param name="inputs">The inputs.</param>
        public DspFertilityForecastAgeTree(params MsfDataSourcePart[] inputs)
            : base(inputs) { }
        ...
        /// The title.
        /// </value>
        public override string Title { get; set; } = Resources.DspFertilityForecastAgeTree;
