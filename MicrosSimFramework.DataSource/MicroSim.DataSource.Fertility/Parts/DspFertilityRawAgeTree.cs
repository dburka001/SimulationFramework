...
namespace MicroSim.DataSource.Fertility
{
    ...
    public class DspFertilityRawAgeTree : MsfDataSourcePart<FertilityCompleteBaseEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DspFertilityRawAgeTree"/> class.
        /// </summary>
        /// <param name="inputs">The inputs.</param>
        public DspFertilityRawAgeTree(params MsfDataSourcePart[] inputs)
            : base(inputs) { }
        ...
        /// The title.
        /// </value>
        public override string Title { get; set; } = Resources.DspFertilityRawAgeTree;
