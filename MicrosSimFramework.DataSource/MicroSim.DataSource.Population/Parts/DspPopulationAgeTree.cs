...
{
    /// <summary>
    /// DspPopulationAgeTree class
    /// </summary>
    /// <seealso cref="MicroSim.DataSource.Core.MsfDataSourcePart" />
    public class DspPopulationAgeTree : MsfDataSourcePart<PopulationBaseEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DspPopulationAgeTree"/> class.
        /// </summary>
        /// <param name="inputs">The inputs.</param>
        public DspPopulationAgeTree(params MsfDataSourcePart[] inputs)
            : base(inputs) { }
        ...
        /// The title.
        /// </value>
        public override string Title { get; set; } = Resources.DspPopulationAgeTree;
